...
Please, address the following to make sure the proposal is eligible:
...
- [ ] Impact we are expecting with this category and how we will measure it (success criteria).
...
- [ ] Support in Fleet
- [ ] Update package-spec dependency in the elastic-package repository to support new category (and create a new elastic-package release).
- [ ] Update elastic-package dependency in the integrations repository.
