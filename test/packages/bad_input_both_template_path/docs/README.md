...
*/}}
# Good Input Template Paths Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The Good Input Template Paths integration for Elastic enables collection of ...
...
The Good Input Template Paths integration collects log messages of the following types:
* ...
