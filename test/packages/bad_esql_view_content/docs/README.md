...
*/}}
# bad esql view content Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The bad esql view content integration for Elastic enables collection of ...
...
The bad esql view content integration collects log messages of the following types:
* ...
