...
*/}}
# Deprecated Integration Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The Deprecated Integration integration for Elastic enables collection of ...
...
The Deprecated Integration integration collects log messages of the following types:
* ...
