...
*/}}
# This is a sample composable package. Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The This is a sample composable package. integration for Elastic enables collection of ...
...
The This is a sample composable package. integration collects log messages of the following types:
* ...
