...
*/}}
# bad deployer system test Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The bad deployer system test integration for Elastic enables collection of ...
...
The bad deployer system test integration collects log messages of the following types:
* ...
