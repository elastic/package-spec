...
func TestValidateWarnings(t *testing.T) {
	...
	tests := map[string][]string{
		...
		"good_v2": {},
		"good_v3": {
			"package-level conditions.agent.version is deprecated, and will be disallowed in a future spec version (SVR00011)",
		},
...
func TestBuildModeValidation(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"bad_built_fs_artifacts": {
			expectedErrContains: []string{
				"source-only folder is not allowed in build packages",
