...
func TestValidateFile(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"input_policy_template_invalid": {
			...
			expectedErrContains: []string{
				"policy template \"sample\" references template_path \"missing.yml.hbs\": file does not exist",
			},
		},
		...
		"stream_templates_invalid": {
			...
			expectedErrContains: []string{
				"stream \"filestream\" references template_path \"missing.yml.hbs\" but file does not exist",
			},
		},
	}
