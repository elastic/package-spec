...
func TestValidateFile(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"kibana_legacy_visualizations": {
			...
			"kibana/visualization/kibana_legacy_visualizations-1ef680d0-596e-11ee-adef-4fe896364076.json",
			"kibana/visualization/kibana_legacy_visualizations-29c51300-596e-11ee-adef-4fe896364076.json",
			"kibana/visualization/kibana_legacy_visualizations-2e364fd0-596e-11ee-adef-4fe896364076.json",
			"kibana/visualization/kibana_legacy_visualizations-331b3600-596e-11ee-adef-4fe896364076.json",
			"kibana/visualization/kibana_legacy_visualizations-38222320-596e-11ee-adef-4fe896364076.json",
			"kibana/visualization/kibana_legacy_visualizations-e6e022a0-596d-11ee-adef-4fe896364076.json",
			...
			[]string{
				...
				"found legacy visualization \"TSVB gauge\" (gauge, TSVB)",
				"found legacy visualization \"Aggs-based table\" (table, Aggs-based)",
				"found legacy visualization \"Aggs-based tag cloud\" (tagcloud, Aggs-based)",
				"found legacy visualization \"Placeholder Title\" (heatmap, Aggs-based)",
				"found legacy visualization \"Timelion time series\" (timelion, Timelion)",
				"found legacy visualization \"Legacy input control vis\" (input_control_vis, Aggs-based)",
