...
func (s *ItemSpec) ValidateSchema(fsys fs.FS, itemPath string) pve.ValidationErrors {
...
func (s *folderItemSpec) ValidateSchema(fsys fs.FS, itemPath string) pve.ValidationErrors {
	if s.schema == nil {
		return nil
	}
