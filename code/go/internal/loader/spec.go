...
func LoadSpec(fsys fs.FS, version semver.Version, pkgType string, fileSpecLoader spectypes.FileSchemaLoader) (spectypes.ItemSpec, error) {
	if fileSpecLoader == nil {
