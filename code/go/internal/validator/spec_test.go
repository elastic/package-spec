...
func Test_ValidateStreamTemplates(t *testing.T) {
	...
	t.Run("stream_templates_valid", func(t *testing.T) {
		// valid package
	...
	t.Run("stream_templates_invalid", func(t *testing.T) {
		// invalid package
...
func Test_ValidateInputPolicyTemplates(t *testing.T) {
	spec, err := NewSpec(*semver.MustParse("3.2.0"))
	require.NoError(t, err)

	t.Run("input_policy_template_valid", func(t *testing.T) {
		// valid package
		pkg, err := packages.NewPackage("testdata/packages/input_policy_template_valid")
		require.NoError(t, err)
	...
	t.Run("input_policy_template_invalid", func(t *testing.T) {
		// invalid package
		pkg, err := packages.NewPackage("testdata/packages/input_policy_template_invalid")
		require.NoError(t, err)

		errs := spec.ValidatePackage(*pkg)
		require.NotEmpty(t, errs)
		assert.Contains(t, errs.Error(), "references template_path \"missing.yml.hbs\": file \"testdata/packages/input_policy_template_invalid/agent/input/missing.yml.hbs\" does not exist")
	})

	t.Run("integration_policy_template_valid", func(t *testing.T) {
		// valid package
		pkg, err := packages.NewPackage("testdata/packages/integration_policy_template_valid")
		require.NoError(t, err)
	...
	t.Run("integration_policy_template_invalid", func(t *testing.T) {
		// invalid package
		pkg, err := packages.NewPackage("testdata/packages/integration_policy_template_invalid")
		require.NoError(t, err)

		errs := spec.ValidatePackage(*pkg)
		require.NotEmpty(t, errs)
		assert.Contains(t, errs.Error(), "references template_path \"missing.yml.hbs\": file \"testdata/packages/integration_policy_template_invalid/agent/input/missing.yml.hbs\" does not exist")
	})
