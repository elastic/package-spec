...
func (s Spec) rules(pkgType string, rootSpec spectypes.ItemSpec) validationRules {
	...
	rulesDef := []struct {
		...
		{fn: semantic.ValidateExternalFieldsWithDevFolder, types: []string{"integration", "input"},
			modes: []modes.Mode{modes.Legacy, modes.Source}},
		...
		{fn: semantic.ValidateIntegrationInputQualifier, types: []string{"integration"}, since: semver.MustParse("3.6.0"),
			modes: []modes.Mode{modes.Legacy, modes.Build}},
		...
		{fn: semantic.ValidateNoEmbeddedEcsInDynamicTemplates, types: []string{"integration"},
			modes: []modes.Mode{modes.Source}},
		{fn: semantic.ValidateNoDevFolder, modes: []modes.Mode{modes.Build}},
		{fn: semantic.ValidateNoLinkFiles, modes: []modes.Mode{modes.Build}},
		{fn: semantic.ValidateNoExternalEcs, modes: []modes.Mode{modes.Build}},
		{fn: semantic.ValidateStreamInputMaterialized, modes: []modes.Mode{modes.Build},
