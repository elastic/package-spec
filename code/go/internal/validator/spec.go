...
func (s Spec) rules(pkgType string, rootSpec spectypes.ItemSpec) validationRules {
	rulesDef := []struct {
		...
		{fn: semantic.ValidateStreamTemplates, types: []string{"integration"}, since: semver.MustParse("3.6.0")},
		{fn: semantic.ValidateInputPolicyTemplates, types: []string{"integration", "input"}, since: semver.MustParse("3.6.0")},
	}
