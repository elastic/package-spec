...
require (
	...
	github.com/elastic/elastic-package v0.126.2
...
require (
	...
	github.com/elastic/elastic-integration-corpus-generator-tool v0.12.4 // indirect
	...
	google.golang.org/adk v1.6.0 // indirect
