...
# Run compliance tests against spec version 3.6.4
TEST_SPEC_VERSION=3.6.4 make -C compliance test

# Run only specific feature files (comma-separated, paths relative to compliance/)
TEST_SPEC_VERSION=3.6.4 TEST_SPEC_FEATURES=features/basic.feature,features/package-dependencies.feature make -C compliance test
...
```go
{
	...
	Version: semver.MustParse("3.6.4"),
}
```
